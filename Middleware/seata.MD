...
#### <a id="appendix-2">附录2：关于grouplist问题说明</a>
关于grouplist问题说明下。
...
#### <a id="appendix-3">附录3：log_status</a>
...
#### <a id="appendix-6">附录6：服务自动降级策略</a>
关于服务自动降级策略的具体实现介绍:
